...
@Singleton
@Service(binding = ChannelHandler.class, named = BootHttpRequestHandler.BINDING_NAME, implTag="my1")
public class HttpRequestHandler1 extends DefaultHttpRequestHandler {
